      ...
      checks.forEach(function(check){
        ...
        _data.read('checks', check, function(err,originalCheckData){
            if(!err && originalCheckData){
              // Pass the data to check validator, and let that function continue or let that function call error
...
workers.validateCheckData = function(originalCheckData){
    ...
    // Set the keys tha tmay not be set (if the workser have never seen this check before)
...
// Alert the user as to aa change in their check status.
...
workers.init = function(){
  ...
  // Call the loop os the cecks will execute later on
  workers.loop();
